...
con.connect(function (err) {
  ...
  const sql =
    'SELECT * FROM users LEFT JOIN products ON users.favorite_product = products.id UNION SELECT * FROM users RIGHT JOIN products ON users.favorite_product = products.id';
